...
public class Movement {
     ...
     */
    public static void cursorUp(int numTimes) {
     ...
     */
    public static void cursorDown(int numTimes) {
     ...
     */
    public static void cursorLeft(int numTimes) {
     ...
     */
    public static void cursorRight(int numTimes) {
